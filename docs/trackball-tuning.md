...
|---|---|---|---|---|
| 5 | Spaces/Mission Control | 4 | 160 | 650 |
| 6 | ブラウザタブ | 4 | 160 | 650 |
| 7 | Launchpad/デスクトップ | 10 | 220 | 900 |

Layer 5 は初動を拾いやすくしつつ二重入力を避けるため、threshold は軽く、tick と wait-ms は重めに設定している。
Layer 6 は検証のため Layer 5 と同じ値に揃えている。Layer 7 は Launchpad 系の誤爆を避けるため、threshold/tick/wait-ms を重めに戻した。
